...
public class ImageAnalyseUtil {
	...
	public static String generateFingerprint(File file) {
		...
		return generateFingerprint(source);
	}
	 ...
	 * @return
	 */
	public static String generateFingerprint(BufferedImage source) {
		int width = 8;
		int height = 8;
		// 第一步，缩小尺寸。
